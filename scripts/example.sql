...
SELECT sources.label, elements.label, source_elements.value, elements.description, elements.comment
FROM sources
...
#Get Element Sets
SELECT elements.label, source_elements.value, elements.description, element_sets.label as 'element_set', elements.comment,  elements.uri
